...
import requests
from teledocai.retrieval.web.main import SearchResult, get_filtered_results
from teledocai.env import SRC_LOG_LEVELS
...
def search_searxng(
    ...
    **kwargs,
    ...
    response = requests.get(
        query_url,
        headers={
            "User-Agent": "TeledocAI (https://github.com/open-webui/open-webui) RAG Bot",
            "Accept": "text/html",
