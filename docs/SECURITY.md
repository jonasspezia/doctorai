...
Our primary goal is to ensure the protection and confidentiality of sensitive data stored by users on TeledocAI.
...
For immediate concerns or detailed reports that meet our guidelines, please create an issue in our [issue tracker](/TeledocAI/TeledocAI/issues) or contact us on [Teledoc](https://teledocmedical.com).
